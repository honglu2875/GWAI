...
CASES: tuple[Case, ...] = (
    ...
    Case(
        ...
        "Post-graph-parallelism stable-graph marking frontier probe.",
    ),
    Case(
        "extended",
        "formula",
        ...
        "Post-graph-parallelism stable-graph genus frontier probe.",
    ),
    Case(
        "extended",
        "psi",
        ...
        "g=12, one psi class",
        ("psi", "--g", "12", "--powers", "34"),
        "Point-theory recursion near the new one-minute band.",
    ),
    Case(
        "extended",
        "psi",
        ...
        "g=13, one psi class",
        ("psi", "--g", "13", "--powers", "37"),
        "Point-theory recursion timeout bracket.",
    ),
    Case(
        "extended",
        "series",
    ...
    Case(
        ...
        "series",
        "markings_psi",
        "p2_g1_dmax2_m4_k3_series",
        "P^2, g=1, d<=2, markings<=4, psi<=3",
        (
            "series",
            "--n",
            "2",
        ...
        "Sparse potential candidate-enumeration frontier probe.",
    ),
    Case(
        "extended",
        "series",
        "markings_psi",
        "p2_g1_dmax2_m5_k3_series",
        "P^2, g=1, d<=2, markings<=5, psi<=3",
        (
            "series",
            "--n",
            "2",
        ...
        "Sparse potential timeout bracket from one extra marking.",
    ),
    Case(
        "extended",
        "twisted",
        ...
        "local_p2_g2_d5",
        "P^2, O(-3), g=2, d=5",
        ("twisted", "--n", "2", "--twist", "-3", "--g", "2", "--d", "5"),
        "Local P2 degree frontier probe.",
    ),
    Case(
        "extended",
        "twisted",
        ...
        "local_p2_g2_d6",
        "P^2, O(-3), g=2, d=6",
        ("twisted", "--n", "2", "--twist", "-3", "--g", "2", "--d", "6"),
        "Local P2 degree timeout bracket.",
    ),
    Case(
        "extended",
        "twisted",
        "equivariant",
        "o1_p2_equivariant_d2_expanded",
        "P^2, O(-1), g=0, d=2, equivariant expanded coefficients",
        (
            "twisted",
            "--n",
            "2",
        ...
        "Symbolic equivariant twisted timeout probe.",
    ),
    Case(
        "extended",
        "twisted",
        "equivariant",
        "o1_p2_equivariant_d2_factored",
        "P^2, O(-1), g=0, d=2, equivariant factored coefficients",
        (
            "twisted",
            "--n",
            "2",
        ...
        "Factored symbolic equivariant twisted timeout probe.",
    ),
    Case(
        "extended",
        "product",
        "genus_degree",
        "p1xp1_g3_d4_one_descendant",
        "P^1 x P^1, g=3, total d=4, tau9(point)",
        (
            "product",
            "--n",
            "1",
        ...
        "Product genus/degree frontier probe.",
    ),
    Case(
        "extended",
        "bundle",
        "genus_degree",
        "f2_g1_d8_three_descendants",
        "P(O+O(2)), g=1, shifted d=8, three tau1(point)",
        (
            "bundle",
            "--n",
            "1",
        ...
        "F2 genus/degree frontier probe.",
    ),
    Case(
        "extended",
        "bundle",
