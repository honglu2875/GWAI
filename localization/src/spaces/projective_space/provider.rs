//! Projective-space semisimple provider and its J-function calibration,
//! descendant S-matrix, and H-multiplication construction.
...
use crate::givental::{
    calibration_from_canonical_frame, calibration_to_factored, canonical_evaluation_matrix,
    classical_limit_diagonal_coefficients, classical_limit_diagonal_coefficients_at_lambda_weights,
    descendant_s_from_divisor_qde, elementary_symmetric_rational, qseries_to_factored,
    series_s_matrix_to_factored, CalibrationId, CanonicalFrame, GiventalGraphKernel,
    SemisimpleCalibration, SemisimpleCohftProvider, SeriesSMatrix, Truncation,
};
use crate::reconstruction::multiply_qseries_polynomial_by_linear;
use std::sync::{Arc, Mutex, OnceLock};

use super::api::{ComputeMode, Insertion, InvariantRequest};
use super::seeds::seed_compute;
use super::{elementary_symmetric_weights, FrobeniusData, ProjectiveSpaceTheory};
...
impl SemisimpleCohftProvider for ProjectiveSpaceProvider {
    ...
    fn scalar_fallback_value(
        ...
        match seed_compute(&req, "givental-seed") {
...
/// Materialize and cache the universal graph-local kernel for one
/// projective-space calibration.
...
mod canonical_provider_tests {
    ...
    #[test]
    fn factored_provider_uses_the_canonical_dimension_semantics() {
